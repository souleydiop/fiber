/* ============================================================
   ...
   Les fonctions pures (mathématiques / formatage / corrélation GPS
   sans dépendance DOM) vivent dans logic.js et sont testées avec
   `node --test`. Ce fichier les importe et les réexpose sur window
   pour rester compatible avec map.js et index.html.
   ============================================================ */
...
/* ================================================================
   UTILITAIRES (non-purs : DOM / encodage binaire)
   ================================================================ */
function toast(msg){
